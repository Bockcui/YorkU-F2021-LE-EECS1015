...
class SeaLife:
    ...
    def __init__(self, direction, pos):
        ...
        assert 0 < pos < 39, 'Position must be between 1 and 38'
        self.direction = direction
        self.pos = pos
        self.cat = SeaLife.category[ri(0,3)]
        self.speed = ri(SeaLife.speed_range[self.cat][0], SeaLife.speed_range[self.cat][1])/10
    ...
    def getStr(self):
        return int(self.pos) * " " + SeaLife.draw[self.cat][self.direction] + (42 - int(self.pos)) * " " + self.cat
